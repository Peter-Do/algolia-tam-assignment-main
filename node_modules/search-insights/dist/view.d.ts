 ...
 */
export declare function viewedObjectIDs(params: InsightsSearchViewObjectIDsEvent): void;
 ...
 */
export declare function viewedFilters(params: InsightsSearchViewFiltersEvent): void;
