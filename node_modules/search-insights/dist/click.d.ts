 ...
 */
export declare function clickedObjectIDsAfterSearch(params: InsightsSearchClickEvent): void;
 ...
 */
export declare function clickedObjectIDs(params: InsightsClickObjectIDsEvent): void;
 ...
 */
export declare function clickedFilters(params: InsightsClickFiltersEvent): void;
